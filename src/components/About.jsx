...
const About = () => {
    return (
     ...
     className="text-5xl md:text-6xl lg:text-7xl text-center text-wrap mt-20 font-mono font-bold">ABOUT ME</div>
       ...
       <div className="grid">
       <div data-aos="fade-left"
     data-aos-easing="linear" className="text-wrap p-2 md:h-full font-mono pt-3">I have experience
     in <span className="text-cyan-400"> frontend </span>  development ,<span className="text-cyan-400"> backend</span>,<span className="text-cyan-400"> databases</span> as well as <span className="text-cyan-400">AWS</span>.I like to learn things by building projects.
     I am passionate about creating user-friendly and scalable web applications.
