...
<div className="min-h-auto min-w-48 max-w-10 overflow-hidden  text-center">
             <img src="orchid.png" alt="orchid" className="hover:scale-125 h-[20rem] object-cover ease-in duration-150"/>
            </div>
...
<div className="min-h-auto min-w-48 max-w-10 w-100 overflow-hidden border text-center">
     <img src="taskify-photo.png" alt="orchid" style={{objectFit: "cover"}} className="hover:scale-125 object-cover  h-[20rem] ease-in duration-150"/>
  </div>
</div>
