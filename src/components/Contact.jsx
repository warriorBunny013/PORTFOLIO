...
const Contact = () => {
	...
	<div className="container mx-auto my-4 px-4 lg:px-40">
		...
		<div className="text-4xl font-mono uppercase tracking-widest font-bold mb-10">Connect with me </div>
			...
			<a href = "mailto: uditi013@proton.me"><button className=" cursor-pointer mt-5 px-3 py-1 hover:bg-cyan-400 hover:animate-pulse border-2 font-mono" >Click 📩</button></a>
			</div>
